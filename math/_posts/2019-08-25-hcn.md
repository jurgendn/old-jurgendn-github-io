...
Tuy thế, việc tính toán được một cách tương đối diện tích của một vật thể có hình dạng bất kì là không hề dễ. Đột nhiên vào một ngày đẹp trời, người ta nghĩ ra một cách ước lượng tương đối như sau. 
    ...
    - Đếm số lượng ô vuông nằm trong, trên vật thể
...
Dù đã ước lượng được một cách tương đối, tuy nhiên việc ước lượng diện tích theo cách này không hẳn đã đủ độ chính xác cần thiết. Trong thực tế chúng ta cần tính toán chính xác hơn thế. Một cách tự nhiên, ta có thể nghĩ đến việc vẽ một lưới ô vuông nhỏ hơn. Khi đó sự khác biệt giữa 2 ước lượng trở thành:
![Comparison](/assets/img/math/tight_grid.png)
Rõ ràng bằng cách này ta có thể tính toán chính xác hơn hẳn.