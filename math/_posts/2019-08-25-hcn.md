...
![Hình minh họa](/assets/img/math/grid_on_area.png =400px)
...
![measure](/assets/img/math/measure_1.png =100px)
...
Bằng cách cũ, tức là sử dụng một ```lưới chữ nhật``` nhỏ hơn, dễ thấy rằng sai khác giữa 