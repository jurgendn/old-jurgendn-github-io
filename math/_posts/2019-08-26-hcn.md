...
\end{aligned}$$  
Mặt khác, ta có $$\underset{i \to \infty}{lim}{x_i y_i} = \underset{i \to \infty}{lim}{x_i} \underset{i \to \infty}{lim}{y_i} = xy$$; $$\underset{i \to \infty}{lim}{u_i v_i} = \underset{i \to \infty}{lim}{u_i} \underset{i \to \infty}{lim}{v_i} = xy$$.  
